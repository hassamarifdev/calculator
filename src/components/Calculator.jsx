    ...
    <React.Fragment>
      <sectioin>
        <div className="bg-[#000300] h-screen w-96 mx-auto  overflow-hidden mt-10">
          ...
          placeholder="0" 
          value= {number} 
          className="w-full h-full border rounded-lg border-white bg-[#000300] text-4xl text-right pr-5"/>
          </div>
          <div className="grid grid-cols-4 gap-2 mt-10 mx-3">
            <button onClick={handleClick} className="text-gray w-20 h-20 bg-[#59dda8] rounded-lg font-bold text-4xl flex justify-center items-center shadow">AC</button>
            <button className="text-gray w-20 h-20 bg-[#59dda8] rounded-lg font-bold text-4xl flex justify-center items-center shadow">C</button>
            <button className="text-gray w-20 h-20 bg-[#59dda8] rounded-lg font-bold text-4xl flex justify-center items-center shadow">/</button>
            <button className="text-gray w-20 h-42 bg-[#59dda8] rounded-lg font-bold text-4xl flex justify-center items-center shadow row-span-2">+</button>
            ...
            <button className="text-gray w-[171px] h-20 bg-[#59dda8] rounded-lg font-bold text-4xl flex justify-center items-center shadow col-span-2">*</button>
          </div>
        </div>
      </sectioin>
    </React.Fragment>
